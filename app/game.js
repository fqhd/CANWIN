...
function getPlayerTeamId(playerData, playerName) {
...
function findPlayer(playerData, playerName) {
...
function calcDeathTimer(level, time) {
...
function getCharactersBeforeHash(inputString) {
    let result = '';
...
function get_player_team_side(playerData, activePlayer) {
    ...
    summonerName = getCharactersBeforeHash(summonerName);
    for (let p of playerData) {
...
export async function query_game_state() {
